...
if __name__ == '__main__':
    ...
    lq_folder = '/chengdu/zhangminjian/project/BlindCAC_v2/database/lq'  
    gt_folder = '/chengdu/zhangminjian/project/BlindCAC_v2/database/gt'  
    csv_path = '/chengdu/zhangminjian/project/BlindCAC_v2/database/meta_info.csv'  
